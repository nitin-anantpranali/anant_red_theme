...
app_include_css =  ["/assets/anant_red_theme/css/theme.css",]
app_include_js = ["/assets/anant_red_theme/js/theme.js",]
...
override_whitelisted_methods = {
    "frappe.core.doctype.user.user.switch_theme": "anant_red_theme.overrides.switch_theme.switch_theme"
}
#
